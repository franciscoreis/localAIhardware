...
This project is intended to be used by developers so that:
   - They can select what is the more appropriate Local AI to server the intended users/devices profile.
...
In user mode, the text is translated to the browser current language if Chrome Built-in AI Translator is available.
   NOTE: other translation system would be costly (cloud) or would consume the tab's resources (local AI JS).
